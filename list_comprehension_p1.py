...
OBS.: Para entender melhor o que está acontecendo devemos dividir a espressão em duas partes:
...
# List Cromprehension versus Loop
...
# List Comprehension
print([numero * 2for numero in numeros])
